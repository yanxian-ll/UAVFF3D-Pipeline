...
python split_to_ndir_oblique.py --scene A3D-Real/nanfang_part0 --copy
python split_to_ndir_oblique.py --scene A3D-Real/nanfang_part1 --copy

python split_to_ndir_oblique.py --scene A3D-Real/yanghaitang_part0 --copy
python split_to_ndir_oblique.py --scene A3D-Real/yanghaitang_part1 --copy

python split_to_ndir_oblique.py --scene A3D-Real/xiaoxiang_part0 --copy
python split_to_ndir_oblique.py --scene A3D-Real/xiaoxiang_part1 --copy
python split_to_ndir_oblique.py --scene A3D-Real/xiaoxiang_part2 --copy
python split_to_ndir_oblique.py --scene A3D-Real/xiaoxiang_part3 --copy
