...
"""
WHUMVS Dataset using WAI format data.
"""
...
class WHUMVSWAI(BaseDataset):
    ...
    def _load_data(self):
        ...
        split_metadata_path = os.path.join(
            ...
            self.split,
            f"whumvs_scene_list_{self.split}.npy",
        )
...
if __name__ == "__main__":
    ...
    if args.viz:
        rr.script_setup(args, "WHU-MVS_Dataloader")
