...
"""
WildUAV Dataset using WAI format data.
"""
...
class WildUAVWAI(BaseDataset):
    """
    WildUAV dataset containing object-centric and birds-eye-view scenes.
    """
    ...
    def _load_data(self):
        ...
        split_metadata_path = os.path.join(
            ...
            self.split,
            f"wilduav_scene_list_{self.split}.npy",
        )
...
if __name__ == "__main__":
    ...
    if args.viz:
        rr.script_setup(args, "WildUAV_Dataloader")
