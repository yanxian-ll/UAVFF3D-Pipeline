...
from dataset.utils.cropping import crop_resize_if_necessary, crop_resize_if_necessary_with_raw
from dataset.utils.geometry import recover_pinhole_intrinsics_from_ray_directions
...
def load_images_with_raw(
    ...
    for path, img, W1, H1 in loaded_images:
        # Resize and crop the image to the target size
        out = crop_resize_if_necessary_with_raw(img, resolution=target_size, scale=scale)
        img = out[0]
        raw_img = out[1]
