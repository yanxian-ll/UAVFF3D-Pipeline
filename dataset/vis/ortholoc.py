...
"""
OrthoLoc Dataset using WAI format data.
"""
...
class OrthoLocWAI(BaseDataset):
    ...
    def _load_data(self):
        ...
        split_metadata_path = os.path.join(
            ...
            self.split,
            f"ortholoc_scene_list_{self.split}.npy",
        )
...
def get_parser():
    ...
    parser.add_argument(
        "-rd", "--root_dir", 
        default="../data/ortholoc", type=str
    )
    parser.add_argument(
        "-dmd",
        "--dataset_metadata_dir",
...
if __name__ == "__main__":
    ...
    if args.viz:
        rr.script_setup(args, "OrthoLoc_Dataloader")
