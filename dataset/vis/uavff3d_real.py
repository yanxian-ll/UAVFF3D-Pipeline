...
class UAVFF3DRealWAI(BaseDataset):
    """
    ...
    def __init__(
        ...
        *args,
        ...
        # sampling mode
        sampling_mode: str = "mixed",   # "anchor_star" | "random_walk" | "tree" | "greedy_chain" | "mixed"
    ...
    def _load_data(self):
        split_metadata_path = os.path.join(
            ...
            self.split,
            f"UAVFF3D-Real_scene_list_{self.split}.npy",
        )
...
def get_parser():
    ...
    parser.add_argument(
        "-rd", "--root_dir", default="../data/UAVFF3D-Real", type=str
    )
    parser.add_argument(
        "-dmd",
        "--dataset_metadata_dir",
...
# python uavff3d_real.py --viz --serve
...
if __name__ == "__main__":
    ...
    dataset = UAVFF3DRealWAI(
        ...
        sampling_mode="mixed",  # "random_walk" or "greedy_chain"
    )
    print(dataset.get_stats())

    if args.viz:
        rr.script_setup(args, "UAVFF3D-Real_Dataloader")
