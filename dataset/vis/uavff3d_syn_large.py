...
class UAVFF3DSynLargeWAI(BaseDataset):
    """
    ...
    def _load_data(self):
        split_metadata_path = os.path.join(
            ...
            self.split,
            f"UAVFF3D-Syn-L_scene_list_{self.split}.npy",
        )
...
def get_parser():
    ...
    parser.add_argument(
        "-rd", "--root_dir", default="../data/UAVFF3D-Syn-L", type=str
    )
    parser.add_argument(
        "-dmd",
        "--dataset_metadata_dir",
...
# python uavff3d_syn_large.py --viz --serve
...
if __name__ == "__main__":
    ...
    if args.viz:
        rr.script_setup(args, "UAVFF3D-Syn-L_Dataloader")
