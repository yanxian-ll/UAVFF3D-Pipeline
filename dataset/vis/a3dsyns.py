...
class A3DSynSmallWAI(BaseDataset):
    """
    ...
    def _load_data(self):
        split_metadata_path = os.path.join(
            ...
            self.split,
            f"A3D-Syn-S_scene_list_{self.split}.npy",
        )
...
def get_parser():
    ...
    parser.add_argument(
        "-rd", "--root_dir", default="/home/csuzhang/disk/a3dscenes/A3D-Syn-S", type=str
    )
    parser.add_argument(
        "-dmd",
        "--dataset_metadata_dir",
...
if __name__ == "__main__":
    ...
    if args.viz:
        rr.script_setup(args, "A3D-Syn-S_Dataloader")
