...
"""
python split_to_two_tiles.py --scene UAVFF3D-Real/nanfang --copy --suffix0 _part0 --suffix1 _part1
python split_to_two_tiles.py --scene UAVFF3D-Real/yanghaitang --copy --suffix0 _part0 --suffix1 _part1
python split_to_two_tiles.py --scene UAVFF3D-Real/xiaoxiang --copy --suffix0 _tmp0 --suffix1 _tmp1

python split_to_two_tiles.py --scene UAVFF3D-Real/xiaoxiang_tmp0 --suffix0 _part0 --suffix1 _part1
python split_to_two_tiles.py --scene UAVFF3D-Real/xiaoxiang_tmp1 --suffix0 _part2 --suffix1 _part3
